...
export interface DeliveryState { session_id:string; phase:DeliveryPhase; status_text?:string; message?:string; attempt:number; objective:string; verification_summary?:string|null; candidate_commit?:string|null; branch_name?:string; runtime?:'dsh'|'open_code'; work_order?:DeliveryWorkOrder|null; evidence?:DeliveryEvidence[]; build_package_id?:string|null; build_package_ready?:boolean; contract?:{revision:number;acceptance_criteria:{id:string;description:string}[]}; last_verification?:unknown }
...
export interface ProductWorkOrder { work_order_id:string; project_id:string; session_id:string; role:string; status:string; project_revision:number; evidence_id?:string|null; result_ref?:string|null; cancellation_reason?:string|null; }
